...
const PROGRAMS: Immutable.Map<string, string> = Immutable.Map({
  ...
  'MATHEMATICAL_ECONOMICS_': 'Mathematical Economics',
  'MATHEMATICAL_FINANCE_': 'Mathematical Finance',
  ...
  'MATHEMATICS/CHARTERED_PROFESSIONAL_ACCOUNTANCY_': 'Mathematics/Chartered Professional Accountancy',
  ...
  'MATHEMATICAL_PHYSIC': 'Mathematical Physic',
  'OTHER': 'Other',
});
